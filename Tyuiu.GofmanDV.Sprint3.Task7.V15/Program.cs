...
namespace Tyuiu.GofmanDV.Sprint3.Task7.V15
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #3 | Выполнила: Гофман Д. В. | СМАРТб-23-2";
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("* Спринт #3                                                               *");
            Console.WriteLine("* Тема: Оператор цикла for                                                *");
            Console.WriteLine("* Задание #7                                                              *");
            Console.WriteLine("* Вариант 15                                                              *");
            Console.WriteLine("* Выполнила: Гофман Даниил Викторович | СМАРТб-23-2                       *");
            Console.WriteLine("***************************************************************************");
